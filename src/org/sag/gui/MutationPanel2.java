			...
			try {
				...
				if (boxCRC.isSelected()) {
					...
					for (Vector<Object> child : data) {
						if(child.get(4).toString()== null || child.get(4).toString() == "")
							continue;
						try {
					...
					determineValidTests(crc, policyMutator, policyPath, "CRE");
