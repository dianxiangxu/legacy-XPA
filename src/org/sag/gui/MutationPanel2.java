	...
	public void generateMutants() {
		...
		if (result == JOptionPane.OK_OPTION) {
			try {
				...
				if (boxPTF.isSelected() || boxFDR.isSelected()) {
				...
				if (boxCRE.isSelected() || boxRER.isSelected()
						|| boxRTF.isSelected() || boxRCF.isSelected()) {
				...
				if (boxRTR.isSelected()) {
					policyMutator.createRuleTypeReplacedMutants(); // Not
																	// implemented
				}
				...
				if (boxRNF.isSelected() || boxRPTE.isSelected() || boxANF.isSelected()) {
					policyMutator.createRemoveNotFunctionMutants();
					
					// policyx.generate_MCDCCoverage(testPanel, policytable,
				}
